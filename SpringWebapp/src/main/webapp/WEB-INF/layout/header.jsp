...
<ul class="nav bg-dark ">
    ...
    <li class="nav-item">
        <a class="nav-link link-light" href="<c:url value="/cart"/>">Giỏ hàng <span class="badge bg-secondary" id="cart-counter">${cartCounter}</span></a>
    </li>
    ...
    <c:if test="${pageContext.request.userPrincipal.name == null}">
        ...
        <li class="nav-item">
            <a class="nav-link link-danger" href="<c:url value="/register"/>">Đăng ký</a>
        </li>
    </c:if>
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link link-danger" href="<c:url value="/logout"/>">Đăng xuất</a>
        </li>
    </c:if>
</ul>
